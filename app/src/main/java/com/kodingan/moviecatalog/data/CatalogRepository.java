...
public class CatalogRepository implements CatalogDataSource {
    ...
    private CatalogRepository(@NonNull RemoteDataSourceMovie remoteDataSourceMovie, @NonNull LocalDataSourceMovie localDataSourceMovie, @NonNull RemoteDataSourceTv remoteDataSourceTv, @NonNull LocalDataSourceTv localDataSourceTv, AppExecutors appExecutors) {
    ...
    public static CatalogRepository getInstance(RemoteDataSourceMovie remoteDataMovie, LocalDataSourceMovie localDataSourceMovie,RemoteDataSourceTv remoteDataTv,LocalDataSourceTv localDataSourceTv, AppExecutors appExecutors) {
        if (INSTANCE == null) {
            synchronized (CatalogRepository.class) {
                if (INSTANCE == null) {
                    INSTANCE = new CatalogRepository(remoteDataMovie, localDataSourceMovie, remoteDataTv, localDataSourceTv,appExecutors);
                }
            }
        }
        return INSTANCE;
    ...
    public LiveData<Resource<PagedList<MovieEntity>>> getAllMovies() {
        return new NetworkBoundResource<PagedList<MovieEntity>, List<MovieResponse>>(appExecutors) {
            ...
            @Override
            public void saveCallResult(List<MovieResponse> movieResponse) {
                ...
                localDataSourceMovie.insertMovies(movieList);
            }
        }.asLiveData();
    }
    ...
    public LiveData<Resource<MovieWithId>> getMovieWithId(String movieId) {
        return new NetworkBoundResource<MovieWithId, List<MovieResponse>>(appExecutors) {
            ...
            @Override
            protected void saveCallResult(List<MovieResponse> movieResponse) {
